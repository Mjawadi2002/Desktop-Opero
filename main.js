...
async function createWindow () {
    ...
    // Hide the native menu bar on Windows / Linux — app has its own chrome
...
function setupTray () {
    ...
    tray = new Tray(icon);
    tray.setToolTip('Teamyy — Workspace Management');
                ...
                { type: 'separator' },
                {
                    ...
                    click: () => {
                        dialog.showMessageBox(mainWindow, {
                            type   : 'info',
                            title  : 'No Updates',
                            message: 'You are running the latest version of Teamyy Desktop.',
                            buttons: ['OK']
                        });
                    }
                }
